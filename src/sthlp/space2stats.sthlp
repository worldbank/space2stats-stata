{smcl}
{* *! version 0.0 20260203}{...}
{hline}
{pstd}help file for {hi:space2stats}{p_end}
{hline}

{title:Title}

{phang}{bf:space2stats} - This command is used for short description.
{p_end}

{title:Syntax}

{phang}{bf:space2stats} , {bf:{ul:opt}ion1}({it:string})
{p_end}
